<div class="page-header">
    <button id="addAddress" type="button" class="btn btn-primary btn-lg round pull-right"><?php echo lang('add_address');?></button>
    <h1 class="page-title"><?php echo lang('your_addresses');?></h1>
</div>
            ...
            <tbody>
                ...
                <?php foreach($addresses as $a):?>
                    <tr>
                        ...
                        <td>
                            <i class="fa fa-pencil fa-lg text-white-blue" onclick="editAddress(<?php echo $a['id'];?>)"></i>
                            <i class="fa fa-times fa-lg text-red" onclick="deleteAddress(<?php echo $a['id'];?>)"></i>
                        </td>
                    </tr>
                <?php endforeach;?>
            </tbody>
