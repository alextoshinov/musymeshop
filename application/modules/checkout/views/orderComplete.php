    ...
    <div class="col-sm-8">
        ...
        <?php foreach($charges['products'] as $product):
            ...
            if(!empty($product->images[0]))
            {
                ...
                $photo = '<img class="img-responsive product-image" src="'.base_url('uploads/images/full/'.$primary['filename']).'"/>';
            }
            ?>
            ...
            <div class="orderItem">
                <div class="col-nest">
                    <div class="col-sm-8" data-cols="2/3" data-medium-cols="2/3" data-small-cols="2/3">
                    ...
                    <div class="col-sm-4" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
        ...
        <?php endforeach;?>
            ...
            <div class="cartSummaryTotals">
                <div class="col-nest">
                    <div class="col-sm-8" data-cols="2/3" data-medium-cols="2/3" data-small-cols="2/3">
                        <div class="cartSummaryTotalsKey pull-right"><?php echo lang('subtotal');?>:</div>
                    </div>
                    <div class="col-sm-4" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
                        <div class="orderTotalsValue pull-left"><?php echo format_currency($order->subtotal);?></div>
                    </div>
                </div>
                ...
                <?php if(count($charges['shipping']) > 0 || count($charges['tax']) > 0 ):?>
                    <?php foreach($charges['shipping'] as $shipping):?>
                        <div class="col-nest">
                            <div class="col-sm-8" data-cols="2/3" data-medium-cols="2/3" data-small-cols="2/3">
                                <div class="cartSummaryTotalsKey pull-right"><?php echo lang('shipping');?>: <?php echo $shipping->name; ?></div>
                            </div>
                            <div class="col-sm-4" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
                                <div class="orderTotalsValue pull-left"><?php echo format_currency($shipping->total_price); ?></div>
                            </div>
                        </div>
                    <?php endforeach;?>
                    ...
                    <?php foreach($charges['tax'] as $tax):?>
                        <div class="col-nest">
                            <div class="col-sm-8" data-cols="2/3" data-medium-cols="2/3" data-small-cols="2/3">
                                <div class="cartSummaryTotalsKey pull-right"><?php echo lang('taxes');?>: <?php echo $tax->name; ?></div>
                            </div>
                            <div class="col-sm-4" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
                                <div class="orderTotalsValue pull-left"><?php echo format_currency($tax->total_price); ?></div>
                            </div>
                        </div>
                    <?php endforeach;?>
                <?php endif;?>
                ...
                <?php if(count($charges['giftCards']) > 0):?>
                    ...
                    <?php foreach($charges['giftCards'] as $giftCard):?>
                        <div class="col-nest">
                            <div class="col-sm-8" data-cols="2/3" data-medium-cols="2/3" data-small-cols="2/3">
                                <div class="cartSummaryTotalsKey pull-right"><?php echo $giftCard->name; ?> : <?php echo $giftCard->description; ?>
                                </div>
                            </div>
                            <div class="col-sm-4" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3" style="white-space:nowrap;">
                                <div class="orderTotalsValue pull-left"><?php echo format_currency($giftCard->total_price); ?></div>
                            </div>
                        </div>
                    <?php endforeach;?>
                <?php endif;?>
                ...
                <div class="col-nest">
                    <div class="col-sm-8" data-cols="2/3" data-medium-cols="2/3" data-small-cols="2/3">
                        <div class="cartSummaryTotalsKey pull-right"><?php echo lang('grand_total');?>:</div>
                    </div>
                    <div class="col-sm-4" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
                        <div class="orderTotalsValue pull-left"><?php echo format_currency($order->total);?></div>
                    </div>
                </div>
            </div>
        </div>
